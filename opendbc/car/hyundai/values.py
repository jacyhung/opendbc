...
class CarControllerParams:
  ...
  def __init__(self, CP, vEgoRaw=100.):
    ...
    if CP.flags & HyundaiFlags.CANFD:
      #self.STEER_MAX = 384 if vEgoRaw < 11. else 330 if vEgoRaw < 17.9 else 270
      self.STEER_MAX = 384
      self.STEER_DRIVER_ALLOWANCE = 350
      self.STEER_DRIVER_MULTIPLIER = 2
      self.STEER_THRESHOLD = 350
      #self.STEER_DELTA_UP = 10 if vEgoRaw < 11. else 4 if vEgoRaw < 17.9 else 2
      #self.STEER_DELTA_DOWN = 10 if vEgoRaw < 11. else 6 if vEgoRaw < 17.9 else 3
